...
export default function Contato() {
    return (
        <section className='flex justify-center px-6 py-30 text-[#e1e1e6] bg-[#111111c5] bg-radial bg-[radial-gradient(circle_at_center,rgba(113,89,193,0.1)_0%,transparent_70%)]' id="contato">
