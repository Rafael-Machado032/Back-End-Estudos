            ...
            <div className='flex flex-col gap-4 w-full max-w-100 bg-[#1e293b] p-8 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.5)]'>
                ...
                {tipo === "Projeto" ? (
                    ...
                    <div className="flex flex-col gap-4">
                        <div className='flex flex-col gap-1'>
                            <label className='text-[#94a3b8] text-sm font-bold'>Título</label>
                            <input className='border border-[#374151] bg-[#0f172a] rounded-lg py-2 px-4' type="text" placeholder="Ex: Curso Web" />
                        </div>
                        ...
                        <div className='flex flex-col gap-1'>
                            <label className='text-[#94a3b8] text-sm font-bold'>Descrição Curta</label>
                            <textarea className='border border-[#374151] bg-[#0f172a] rounded-lg py-2 px-4 resize-none' rows={3} placeholder="Ex: Um curso web voltado para React e Firebase"></textarea>
                        </div>
